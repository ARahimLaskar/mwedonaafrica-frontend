...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .get(`https://stormy-bat-waders.cyclic.app/products?_limit=3&type=bus`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://stormy-bat-waders.cyclic.app/products?_limit=3&type=pick_up`
      )
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`https://stormy-bat-waders.cyclic.app/products?_limit=3&type=SUVs`)
      .then((res) => {
